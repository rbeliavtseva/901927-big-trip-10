...
class PointController {
  ...
  render(point) {
     ...
     */
    const renderTripDayEventContent = (singleEvent, container) => {
      ...
      */
      const onFavoriteButtonClick = () => {
        ...
        this._onDataChange(singleEvent, updatedFavorite);
      };
      ...
      const onEventTypeItemClick = (evt) => {
        tripDayEventContentEdit._eventData.eventType = evt.target.value;
        tripDayEventContentEdit.rerender();
      };
    ...
    removePoint();
    renderTripDayEventContent(point, this._container);
  }
}
